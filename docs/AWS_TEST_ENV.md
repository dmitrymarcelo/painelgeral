...
- PostgreSQL: ✅
- Redis: ✅
- Ultima atualizacao de contexto: `2026-02-27` (corrigido erro de `next/image` no WebShell ao remover URL externa e usar asset local circular sem deformacao; sem deploy executado neste passo)
