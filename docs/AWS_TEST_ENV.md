...
- PostgreSQL: ✅
- Redis: ✅
- Ultima atualizacao de contexto: `2026-02-27` (ajustes visuais no portal inicial/WebShell, incluindo icone circular da marca; sem deploy executado neste passo)
